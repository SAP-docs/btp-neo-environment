<!-- loiob280fa0fcc974ba5a65c83b7a265341e -->
...
```
neo delete-db-user-ase -a mysubaccount -h hana.ondemand.com -u mymail@example.com -i mydb --db-user mydbuser
```

**Related Information**  


[create-db-user-ase](create-db-user-ase-487b85d.md "This command creates a user of an ASE database.")
