<!-- loio9033ddcb45ef4a1c8ba0b505110d10c2 -->
...
```
neo list-loggers  --account <subaccount_technical_name> --application <application_name> --user <e-mail_or_user> --host <host>
```
...
```
neo list-loggers --account mysubaccount --application demo --user p1234567890 --host hana.ondemand.com
```
