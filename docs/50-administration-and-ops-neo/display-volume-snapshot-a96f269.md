<!-- loioa96f2697efa445a1bdd2cd8cdbff964c -->
...
```
neo display-volume-snapshot --id <snapshot_id> --account <subaccount_technical_name> --user <e-mail_or_user> --host <host>
```
...
```
neo display-volume-snapshot --id mysnapshotid --account mysubaccount --host hana.ondemand.com --user myemail@example.com
```
